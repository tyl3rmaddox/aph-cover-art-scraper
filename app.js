        ...
        for (i in isbnNumbers) {
            ...
            getCover(isbnNumber)
                .then(res => {
                    ...
                    download(res, 'C:/Users/tyler/test/' + isbnNumber + '.webp', function () {
                        console.log('done');
                        convertToJpg();
                    });
                })
            ...
            const convertToJpg = () => {
                const result = webp.dwebp('C:/Users/tyler/test/' + isbnNumber + '.webp', "C:/Users/tyler/test/" + isbnNumber + ".png", "-o", logging = "-v");
            ...
            const cleanUp = () => {
                unlinkP('C:/Users/tyler/test/' + isbnNumber + '.webp')
            }
        }
    }
});